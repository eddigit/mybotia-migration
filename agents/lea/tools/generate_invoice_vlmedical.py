#!/usr/bin/env python3
"""Génère la facture VL Medical avec remise"""
...
def generate_invoice(output_path):
    ...
    client_data = [
        ...
        [Paragraph("<b>VL MEDICAL</b>", styles['Normal'])],
        ["Jean-Luc Aubagnac"],
    ...
    table_data.append([Paragraph("<b>🎁 Remise commerciale</b>", styles['Normal']), '', '', Paragraph("<b>- 500,00 €</b>", styles['Right'])])
...
if __name__ == "__main__":
    output = '/home/gillescoach/.openclaw/workspace/factures/FA-2026-021-VLMedical.pdf'
