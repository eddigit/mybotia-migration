#!/usr/bin/env python3
"""
OAuth Gmail pour Nina — ninacoachdigital@gmail.com
Methode manuelle : ouvre le lien, autorise, colle l'URL de retour.
"""
...
print("\n" + "="*60)
print("NINA — AUTORISATION GMAIL")
print("="*60)
print("\n1) Ouvre ce lien dans ton navigateur :\n")
print(auth_url)
print("\n2) Connecte-toi avec ninacoachdigital@gmail.com")
...
print("   (elle ressemble a : http://localhost/?code=4/0Axx...)\n")
